...
void snake_segment_draw(struct snake_segment *sg, float offset, int tile_width, int tile_height, int field_width, int field_height, float tile_margin) {
  ...
  switch (sg -> dir) {
    ...
    if (sg -> pos -> x <= 0)
      ...
      DrawRectangle((field_width + x_offset) * tile_width, (sg -> pos -> y + y_offset) * tile_height, tile_width * tile_margin, tile_height * tile_margin, sg -> color);
    break;
    ...
    if (sg -> pos -> x >= field_width - 1)
        // Draw extra rectangle on the other side.
      DrawRectangle((-1 + x_offset) * tile_width, (sg -> pos -> y + y_offset) * tile_height, tile_width * tile_margin, tile_height * tile_margin, sg -> color);
    break;
    ...
    if (sg -> pos -> y <= 0)
        // Draw extra rectangle on the other side.
      DrawRectangle((sg -> pos -> x + x_offset) * tile_width, (field_height + y_offset) * tile_height, tile_width * tile_margin, tile_height * tile_margin, sg -> color);
    break;
    ...
    if (sg -> pos -> y >= field_height - 1)
        // Draw extra rectangle on the other side.
      DrawRectangle((sg -> pos -> x + x_offset) * tile_width, (-1 + y_offset) * tile_height, tile_width * tile_margin, tile_height * tile_margin, sg -> color);
    break;
